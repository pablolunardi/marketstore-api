...
alter table merchant_owner auto_increment = 1;
...
insert into merchant_owner (full_name, email, password) values ('Dono do Tio Patinhas', 'tiopatinhas@gmail.com', '123456');
insert into merchant_owner (full_name, email, password) values ('Dono do SM Eletrônicos', 'smeletronicos@gmail.com', '123456');

insert into merchant (name, active, delivery_fee, address_zipcode, address_street_1, address_district, address_city_id, merchant_owner_id) values ('Comercial Tio Patinhas', true, 5.60, '99074-360', 'Av. Aspirante Jenner, 489', 'Vl Sta Maria', 1, 1);
insert into merchant (name, active, delivery_fee, address_zipcode, address_street_1, address_district, address_city_id, merchant_owner_id) values ('SM Eletrônicos', true, 7.00, '99074-360', 'Av. Aspirante Jenner, 489', 'Vl Sta Maria', 1, 2);
...
insert into `order` (order_status, order_sub_total, order_total, delivery_fee, received_date, merchant_id, payment_method_id, customer_id, address_zipcode, address_street_1, address_street_2, address_district, address_city_id) values ('RECEIVED', 12.50, 16.50, 4.00, CURRENT_TIMESTAMP(), 1, 1, 1, '99010-210', 'Rua Enzo 12', 'ap', 'Centro', 1);

insert into order_item (product_id, order_id, unity_price, total_price, quantity, notes) values (1, 1, 12.50, 12.50, 1, 'Seja rápido');